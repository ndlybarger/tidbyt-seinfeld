"""
Applet: Seinfeld Quotes
Summary: Short animation with quote
Description: Sliding Seinfeld logo animation with a random Seinfeld quote scrolling across the bottom.
Author: ndlybarger (special thanks to Marc ten Bosch for lobster facts source code)
"""
